...
**⚠️ Feedback-репортинг:** только full-name эффекты (жирные в таблице
выше: Feedback 0x21, Weapon 0x25, Vibration 0x26 + Bow 0x22,
Galloping 0x23, Machine 0x27) шлют `act` bit и position nybble в
input-report байтах 0x29/0x2A. Simple_* (0x01/0x02/0x06) и Limited_*
(0x11/0x12) тактильно отрабатывают, но feedback-диагностику **не
репортят**. Детали и эмпирические наблюдения —
[`dualsense_adaptive_trigger_facts.md`](dualsense_adaptive_trigger_facts.md)
