...
**Расследование:** `new_game_devlog/stage2_regression_investigation.md` — 18 коммитов проверено, все 14 багов локализованы в одном коммите `4e7ef92`.

**Исправлено в коммите `7215a28`** — 3 файла: `Message.cpp`, `build2.cpp`, `Building.cpp`.
