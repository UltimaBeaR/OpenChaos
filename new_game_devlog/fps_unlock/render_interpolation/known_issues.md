...
### 2b. Тень Дарси не синхронизирована с телом на сменах анимации — ✅ ЗАКРЫТО 2026-05-03
...
**Закрыто 2026-05-03 в Phase 4** ([world_pose_snapshot_plan.md](world_pose_snapshot_plan.md)).
