...
## ✅ 2a. Регресс инпута комбо-ударов — автоматически пропал 2026-05-06

**Был:** при комбо ударов нажатия как будто плохо регистрировались — последовательные нажатия могли не срабатывать.

**Закрыто:** пользователь подтвердил что проблема прошла сама после связанных правок input_frame / fps_unlock. Корень не локализован — скорее всего исправило изменение темпа физики/анимации в рамках Phase 4-Wide input_frame миграции.
