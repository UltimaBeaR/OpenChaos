...
| [fix_progress.md](fix_progress.md) | Трекинг этапов фикса (вариант 1 из workarounds — переписывание на GPU). |
...
- **Карточка бага:** [known_issues_and_bugs.md](../../known_issues_and_bugs/known_issues_and_bugs.md) секция «Крэши» → "Тормоза при загрузке миссии".
