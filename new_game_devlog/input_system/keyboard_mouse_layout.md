...
Было: удары мышкой срабатывали через раз, в зависимости от ситуации.
Стало: после серии правок (в т.ч. упрощение мышиных блоков камеры,
пересмотр input pipeline, синхронизация позиции want/fc) удары
срабатывают стабильно при каждом нажатии. Не воспроизводится.
