...
### BUG-5 ⚠️ REOPENED: ЛКМ/ПКМ удары через раз
...
**История:** временно казалось FIXED после серии камера-правок, но
проблема либо вернулась либо никогда не уходила полностью — просто в
некоторых условиях перестала проявляться. Сейчас снова воспроизводится.
...
**Следующий шаг:** разобраться с этим.
