...
### BUG-CAM-HANG-NEAR-CLIP → перенесён в post-1.0 (см. `../../known_issues_and_bugs/known_issues_and_bugs.md` → Камера)
...
### BUG-CAM-CAR-STUCK-CLOSE → перенесён в post-1.0 (см. `../../known_issues_and_bugs/known_issues_and_bugs.md` → Камера)
...
### BUG-CAM-SMALL-ROT-SHIFT → перенесён в post-1.0 (см. `../../known_issues_and_bugs/known_issues_and_bugs.md` → Камера)
