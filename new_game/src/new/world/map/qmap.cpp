...
// Returns the texture index for a given (x,y) position within a rectangle
// of (size_x,size_y), sampled using the given style entry.
// uc_orig: QMAP_get_style_texture (fallen/Source/qmap.cpp)
static UWORD QMAP_get_style_texture(
    SLONG x,
    SLONG y,
    SLONG size_x,
    SLONG size_y,
