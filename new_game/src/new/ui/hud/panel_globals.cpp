...
// NOTE: Additional globals (help_timer, wide_top_is_talking, beacon_colour,
// fadeout_time, sign_*, info_time, screensaver vars, angle_mul, zoom_mul)
// are still defined in old/panel.cpp - to be moved here when chunk 2+ is migrated.
