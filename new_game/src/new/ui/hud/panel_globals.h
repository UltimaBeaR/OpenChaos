...
// NOTE: Additional globals (PANEL_help_timer, PANEL_wide_top_is_talking,
// PANEL_beacon_colour, PANEL_fadeout_time, PANEL_sign_*, PANEL_info_time,
// screensaver vars, angle_mul, zoom_mul) are still defined in old/panel.cpp
// and will be moved here when chunk 2+ is migrated.
