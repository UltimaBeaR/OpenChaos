...
// set_floor_hidden — declared in world/environment/building.h (chunk 3)

// Forward declarations for functions defined later in this file (chunk 4+).
// create_a_quad, build_face_texture_info, create_a_tri — now in new/building.cpp chunk 3
// (declared in world/environment/building.h, no default redecl needed)
...
// texture_xy2 — migrated to new/world/environment/building.cpp (chunk 3, static)
...
// clear_reflective_flag, get_storey_outline, do_storeys_overlap, build_roof_grid,
// is_storey_circular, set_floor_hidden, build_fe_mid_points, build_fire_escape_points,
// build_face_texture_info, set_quad_planar_flag, create_a_quad, create_a_quad_tex,
// create_a_tri, set_texture_fe, next_connected_face, build_firescape,
// build_ladder_points, calc_ladder_pos
// -- all migrated to new/world/environment/building.cpp (chunk 3)

// (get_storey_outline and remaining chunk-3 functions migrated — see redirect comment above)
