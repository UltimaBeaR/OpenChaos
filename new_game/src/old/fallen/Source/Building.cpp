// Chunk 5+ of Building.cpp — chunks 1–4 migrated to new/world/environment/building.cpp.
// This file contains the remaining functions (original lines ~5760+).
// Globals and chunks 1–4 functions now live in new/world/environment/building*.
...
// Forward declarations for functions still defined later in this file (chunk 5+).
void calc_building_normals(void);

// Chunks 1–4 migrated: texture_xy2, set_UV4, build_free_tri/quad_texture_info, scan_45,
// build_storey_lip, current_building, create_walkable_structure, calc_face_split,
// ROT1/2/3, lookup_roof[], build_easy_roof, clear_reflective_flag, get_storey_outline,
// do_storeys_overlap, build_roof_grid, is_storey_circular, set_floor_hidden,
// build_fe_mid_points, build_fire_escape_points, build_face_texture_info,
// set_quad_planar_flag, create_a_quad, create_a_quad_tex, create_a_tri, set_texture_fe,
// next_connected_face, build_firescape, build_ladder_points, calc_ladder_pos,
// flat_fill_a_quad_of_points, build_skylight, build_ladder, build_ladder_old,
// calc_sin_from_cos, calc_new_corner_point, build_ledge, create_strip_points,
// build_outline, ladder_on_block, build_ledge2
// -- all now in new/world/environment/building.cpp
