...
const InputGlyph INPUT_GLYPHS[] = {
    ...
    // ---- Keyboard letters ----
    { "kb_a", "A", GLYPH_DEV_KBM, 5, 14 },
    { "kb_b", "B", GLYPH_DEV_KBM, 6, 12 },
    { "kb_c", "C", GLYPH_DEV_KBM, 6, 11 },
    { "kb_d", "D", GLYPH_DEV_KBM, 6, 10 },
    { "kb_e", "E", GLYPH_DEV_KBM, 10, 10 },
    { "kb_f", "F", GLYPH_DEV_KBM, 6, 9 },
    { "kb_g", "G", GLYPH_DEV_KBM, 2, 7 },
    { "kb_h", "H", GLYPH_DEV_KBM, 4, 7 },
    { "kb_i", "I", GLYPH_DEV_KBM, 8, 7 },
    { "kb_j", "J", GLYPH_DEV_KBM, 12, 7 },
    { "kb_k", "K", GLYPH_DEV_KBM, 14, 7 },
    { "kb_l", "L", GLYPH_DEV_KBM, 0, 6 },
    { "kb_m", "M", GLYPH_DEV_KBM, 2, 6 },
    { "kb_n", "N", GLYPH_DEV_KBM, 6, 6 },
    { "kb_o", "O", GLYPH_DEV_KBM, 14, 6 },
    { "kb_p", "P", GLYPH_DEV_KBM, 3, 5 },
    { "kb_q", "Q", GLYPH_DEV_KBM, 15, 5 },
    { "kb_r", "R", GLYPH_DEV_KBM, 5, 4 },
    { "kb_s", "S", GLYPH_DEV_KBM, 9, 4 },
    { "kb_t", "T", GLYPH_DEV_KBM, 9, 3 },
    { "kb_u", "U", GLYPH_DEV_KBM, 3, 2 },
    { "kb_v", "V", GLYPH_DEV_KBM, 5, 2 },
    { "kb_w", "W", GLYPH_DEV_KBM, 7, 2 },
    { "kb_x", "X", GLYPH_DEV_KBM, 11, 2 },
    { "kb_y", "Y", GLYPH_DEV_KBM, 13, 2 },
    { "kb_z", "Z", GLYPH_DEV_KBM, 15, 2 },

    // ---- Keyboard digits ----
    { "kb_0", "0", GLYPH_DEV_KBM, 1, 15 },
    { "kb_1", "1", GLYPH_DEV_KBM, 3, 15 },
    { "kb_2", "2", GLYPH_DEV_KBM, 5, 15 },
    { "kb_3", "3", GLYPH_DEV_KBM, 7, 15 },
    { "kb_4", "4", GLYPH_DEV_KBM, 9, 15 },
    { "kb_5", "5", GLYPH_DEV_KBM, 11, 15 },
    { "kb_6", "6", GLYPH_DEV_KBM, 13, 15 },
    { "kb_7", "7", GLYPH_DEV_KBM, 15, 15 },
    { "kb_8", "8", GLYPH_DEV_KBM, 1, 14 },
    { "kb_9", "9", GLYPH_DEV_KBM, 3, 14 },
