// Auto-generated from N:\UrbanChaos\sounds.slb on 16/11/99 14:09:12.
// Maps Waves enum values to sound filenames used by the audio system.

#include "assets/sound_id_globals.h"

// uc_orig: sound_list (fallen/Source/sound_id.cpp)
CBYTE* sound_list[] = {
    "NULL.wav",
    "f_WIND1.wav",
    "f_WIND3.wav",
    ...
    "bthug1/there they are.wav",
    "bthug1/there they are 2.wav",
    ...
    "wthug1/there they are.wav",
    "wthug1/there they are 2.wav",
    "wthug2/huh 1.wav",
    "wthug2/huh 2.wav",
    ...
    "wthug2/there they are.wav",
    "wthug2/there they are 2.wav",
    "music01/Sneak.wav",
    "music01/Sewer.wav",
