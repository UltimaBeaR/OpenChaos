...
// uc_orig: QEDIT_draw_wireframe (fallen/Source/qedit.cpp)
static void QEDIT_draw_wireframe(SLONG world_x, SLONG world_z)
{
    SLONG i;
    ...
    // Draw all QMAP cubes in the visible area as wireframe boxes.
...
#define QEDIT_CUBE_COLOUR 0x00880022
                ...
                QENG_world_line(x1, y1, z1, QEDIT_CUBE_RADIUS, QEDIT_CUBE_COLOUR,
                    x2, y1, z1, QEDIT_CUBE_RADIUS, QEDIT_CUBE_COLOUR, UC_FALSE);
                QENG_world_line(x2, y1, z1, QEDIT_CUBE_RADIUS, QEDIT_CUBE_COLOUR,
                    x2, y1, z2, QEDIT_CUBE_RADIUS, QEDIT_CUBE_COLOUR, UC_FALSE);
                QENG_world_line(x2, y1, z2, QEDIT_CUBE_RADIUS, QEDIT_CUBE_COLOUR,
                    x1, y1, z2, QEDIT_CUBE_RADIUS, QEDIT_CUBE_COLOUR, UC_FALSE);
                QENG_world_line(x1, y1, z2, QEDIT_CUBE_RADIUS, QEDIT_CUBE_COLOUR,
                    x1, y1, z1, QEDIT_CUBE_RADIUS, QEDIT_CUBE_COLOUR, UC_FALSE);
                QENG_world_line(x1, y1, z1, QEDIT_CUBE_RADIUS, QEDIT_CUBE_COLOUR,
                    x1, y2, z1, QEDIT_CUBE_RADIUS, QEDIT_CUBE_COLOUR, UC_FALSE);
                QENG_world_line(x2, y1, z1, QEDIT_CUBE_RADIUS, QEDIT_CUBE_COLOUR,
                    x2, y2, z1, QEDIT_CUBE_RADIUS, QEDIT_CUBE_COLOUR, UC_FALSE);
                QENG_world_line(x1, y1, z2, QEDIT_CUBE_RADIUS, QEDIT_CUBE_COLOUR,
                    x1, y2, z2, QEDIT_CUBE_RADIUS, QEDIT_CUBE_COLOUR, UC_FALSE);
                QENG_world_line(x2, y1, z2, QEDIT_CUBE_RADIUS, QEDIT_CUBE_COLOUR,
                    x2, y2, z2, QEDIT_CUBE_RADIUS, QEDIT_CUBE_COLOUR, UC_FALSE);
                QENG_world_line(x1, y2, z1, QEDIT_CUBE_RADIUS, QEDIT_CUBE_COLOUR,
                    x2, y2, z1, QEDIT_CUBE_RADIUS, QEDIT_CUBE_COLOUR, UC_FALSE);
                QENG_world_line(x2, y2, z1, QEDIT_CUBE_RADIUS, QEDIT_CUBE_COLOUR,
                    x2, y2, z2, QEDIT_CUBE_RADIUS, QEDIT_CUBE_COLOUR, UC_FALSE);
                QENG_world_line(x2, y2, z2, QEDIT_CUBE_RADIUS, QEDIT_CUBE_COLOUR,
                    x1, y2, z2, QEDIT_CUBE_RADIUS, QEDIT_CUBE_COLOUR, UC_FALSE);
                QENG_world_line(x1, y2, z2, QEDIT_CUBE_RADIUS, QEDIT_CUBE_COLOUR,
                    x1, y2, z1, QEDIT_CUBE_RADIUS, QEDIT_CUBE_COLOUR, UC_FALSE);
            }
        }

    // Draw the ground as a grid of line segments.
    bx1 = mx1 << 5;
    bz1 = mz1 << 5;
...
// uc_orig: QEDIT_draw_mapsquare (fallen/Source/qedit.cpp)
static void QEDIT_draw_mapsquare(UBYTE map_x, UBYTE map_z)
{
...
// uc_orig: QEDIT_init (fallen/Source/qedit.cpp)
static void QEDIT_init(void)
{
    QMAP_init();
...
// uc_orig: QEDIT_control (fallen/Source/qedit.cpp)
static void QEDIT_control(void)
{
    SLONG len_x;
    SLONG len_z;
...
#define QEDIT_SPEED_ZOOM ((ShiftFlag) ? 0x600 : 0x300)
    ...
    if (Keys[KB_UP]) {
        QEDIT_focus_x += QEDIT_cam_matrix[6];
        QEDIT_focus_z += QEDIT_cam_matrix[8];
    }
    if (Keys[KB_DOWN]) {
        QEDIT_focus_x -= QEDIT_cam_matrix[6];
        QEDIT_focus_z -= QEDIT_cam_matrix[8];
    ...
    if (Keys[KB_LEFT]) {
        QEDIT_focus_x += QEDIT_cam_matrix[0];
        QEDIT_focus_z += QEDIT_cam_matrix[2];
    }
    if (Keys[KB_RIGHT]) {
        QEDIT_focus_x -= QEDIT_cam_matrix[0];
        QEDIT_focus_z -= QEDIT_cam_matrix[2];
    ...
    if (Keys[KB_DEL]) {
        QEDIT_cam_yaw -= QEDIT_SPEED_ROTATE;
    }
    if (Keys[KB_PGDN]) {
        QEDIT_cam_yaw += QEDIT_SPEED_ROTATE;
    }
    ...
    if (Keys[KB_INS]) {
        QEDIT_cam_pitch -= QEDIT_SPEED_ROTATE;
    }
    if (Keys[KB_PGUP]) {
        QEDIT_cam_pitch += QEDIT_SPEED_ROTATE;
    }
    ...
    if (Keys[KB_HOME]) {
        QEDIT_cam_zoom -= QEDIT_SPEED_ZOOM;
    }
    if (Keys[KB_END]) {
        QEDIT_cam_zoom += QEDIT_SPEED_ZOOM;
    }
    ...
    // Stick camera focus to the terrain surface.
    QEDIT_focus_y = QMAP_calc_height_at(QEDIT_focus_x, QEDIT_focus_z);

    // Recompute matrix after angle updates.
    FMATRIX_calc(
        QEDIT_cam_matrix,
        QEDIT_cam_yaw,
        QEDIT_cam_pitch,
...
// uc_orig: QEDIT_draw (fallen/Source/qedit.cpp)
static void QEDIT_draw(void)
{
...
// uc_orig: QEDIT_loop (fallen/Source/qedit.cpp)
void QEDIT_loop()
{
    SLONG quit = UC_FALSE;
