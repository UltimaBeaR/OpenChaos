...
void weapon_feel_init()
{
    ...
    // TEST: extreme values — startPos=2 (very early click), endPos=8 (very late),
    // strength=8 (maximum). If this feels identical to the previous 4/6/5 config
    // the controller is ignoring our byte layout.
    WeaponFeelProfile pistol = {
        /*haptic_wave_id*/    S_PISTOL_SHOT,
        /*haptic_gain*/       0.05f,
        /*haptic_ceiling*/    18,
        /*haptic_max_seconds*/0.035f,
        /*trigger_start_zone*/2,
        /*trigger_end_zone*/  8,
        /*trigger_strength*/  8,
        /*fire_threshold*/    200,
        /*reset_threshold*/   80,
