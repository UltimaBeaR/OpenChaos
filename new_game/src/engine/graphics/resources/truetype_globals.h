#ifndef ENGINE_GRAPHICS_RESOURCES_TRUETYPE_GLOBALS_H
#define ENGINE_GRAPHICS_RESOURCES_TRUETYPE_GLOBALS_H
...
#endif // ENGINE_GRAPHICS_RESOURCES_TRUETYPE_GLOBALS_H
