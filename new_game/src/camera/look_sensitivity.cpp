...
float CAM_mouse_orbit_sensitivity()   { ensure_loaded(); return s_mouse_sens; }
float CAM_gamepad_orbit_sensitivity() { ensure_loaded(); return s_gamepad_sens; }
bool  CAM_mouse_invert_y()            { ensure_loaded(); return s_mouse_invert_y; }
bool  CAM_gamepad_invert_y()          { ensure_loaded(); return s_gamepad_invert_y; }
