...
public:
    ...
    // listener
    inline void ListenPos(float x, float y, float z)
    {
        if (a3dlis)
            a3dlis->SetPosition3f(x, y, z);
    };
    inline void ListenRot(float head, float roll, float pitch)
    {
        if (a3dlis)
            a3dlis->SetOrientationAngles3f(head, pitch, roll);
    };
...
public:
    ...
    {
        if (a3dsrc)
            a3dsrc->SetPriority(priority);
    };
    void SetMute(UBYTE mute);
    void Set3D(UBYTE is3d);
    inline void SetGain(UBYTE vol)
    {
        if (a3dsrc)
            a3dsrc->SetGain(((float)vol) / 255.0f);
    };
    ...
    // 3D
    inline void SetPositionf(float x, float y, float z)
    {
        if (a3dsrc)
            a3dsrc->SetPosition3f(x, y, z);
    };
    inline void SetPositionl(SLONG x, SLONG y, SLONG z)
    {
        if (a3dsrc)
            a3dsrc->SetPosition3f((float)x, (float)y, (float)z);
    };
    inline void SetRotationf(float h, float r, float p)
    {
        if (a3dsrc)
            a3dsrc->SetOrientationAngles3f(h, r, p);
    };
    inline void SetRotationl(SLONG h, SLONG r, SLONG p)
    {
        if (a3dsrc)
            a3dsrc->SetOrientationAngles3f((float)h, (float)r, (float)p);
    };
    inline void SetVelocityf(float x, float y, float z)
    {
        if (a3dsrc)
            a3dsrc->SetVelocity3f(x, y, z);
    };
    inline void SetVelocityl(SLONG x, SLONG y, SLONG z)
    {
        if (a3dsrc)
            a3dsrc->SetVelocity3f((float)x, (float)y, (float)z);
    };

    // audio properties
    inline void SetPitchf(float pitchbend)
    {
        if (a3dsrc)
            a3dsrc->SetPitch(pitchbend);
    };
    inline void SetGainf(float gain)
    {
        if (a3dsrc)
            a3dsrc->SetGain(gain);
    };
