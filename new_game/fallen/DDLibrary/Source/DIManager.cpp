...
BOOL DIDeviceInfo::DIEnumDeviceObjectsProc(LPCDIDEVICEOBJECTINSTANCE pDIDOI)
{
    if ((LOBYTE(LOWORD(pDIDOI->dwType)) & DIDFT_AXIS) != 0) {
        ...
        if (NumButtons < 32) {
            ...
            case USAGE_A_BUTTON:
                iMapping = MY_DC_BUTTON_A;
                break;
            case USAGE_B_BUTTON:
                iMapping = MY_DC_BUTTON_B;
                break;
            case USAGE_C_BUTTON:
                iMapping = MY_DC_BUTTON_C;
                break;
            case USAGE_D_BUTTON:
                iMapping = MY_DC_BUTTON_D;
                break;
            case USAGE_START_BUTTON:
                iMapping = MY_DC_BUTTON_START;
                break;
            case USAGE_LA_BUTTON:
                iMapping = MY_DC_BUTTON_LEFT;
                break;
            case USAGE_RA_BUTTON:
                iMapping = MY_DC_BUTTON_RIGHT;
                break;
            case USAGE_DA_BUTTON:
                iMapping = MY_DC_BUTTON_DOWN;
                break;
            case USAGE_UA_BUTTON:
                iMapping = MY_DC_BUTTON_UP;
                break;
            case USAGE_X_BUTTON:
                iMapping = MY_DC_BUTTON_X;
                break;
            case USAGE_Y_BUTTON:
                iMapping = MY_DC_BUTTON_Y;
                break;
            case USAGE_Z_BUTTON:
                iMapping = MY_DC_BUTTON_Z;
                break;
            case USAGE_LB_BUTTON:
                iMapping = MY_DC_BUTTON_2_LEFT;
                break;
            case USAGE_RB_BUTTON:
                iMapping = MY_DC_BUTTON_2_RIGHT;
                break;
            case USAGE_DB_BUTTON:
                iMapping = MY_DC_BUTTON_2_DOWN;
                break;
            case USAGE_UB_BUTTON:
                iMapping = MY_DC_BUTTON_2_UP;
                break;
            case USAGE_RTRIG_BUTTON:
                iMapping = MY_DC_BUTTON_RTRIGGER;
                break;
            case USAGE_LTRIG_BUTTON:
                iMapping = MY_DC_BUTTON_LTRIGGER;
                break;
            case USAGE_AN3_BUTTON:
                iMapping = MY_DC_BUTTON_AN3;
                break;
            case USAGE_AN4_BUTTON:
                iMapping = MY_DC_BUTTON_AN4;
                break;
            case USAGE_AN5_BUTTON:
                iMapping = MY_DC_BUTTON_AN5;
                break;
            case USAGE_AN6_BUTTON:
                iMapping = MY_DC_BUTTON_AN6;
                break;
            default:
...
BOOL DIDeviceInfo::GetThisDevice(UBYTE type)
{
    ...
    if ((strstr(Product, "fishing") != NULL) || (strstr(Product, "FISHING") != NULL) || (strstr(Product, "Fishing") != NULL)) {
        for (int j = 0; j < 32; j++) {
            switch (ButtonMappings[j]) {
            case MY_DC_BUTTON_C:
                ButtonMappings[j] = MY_DC_BUTTON_BOGUS;
                break;
            case MY_DC_BUTTON_Z:
                ButtonMappings[j] = MY_DC_BUTTON_BOGUS;
                break;
            case MY_DC_BUTTON_2_LEFT:
                ButtonMappings[j] = MY_DC_BUTTON_BOGUS;
                break;
            case MY_DC_BUTTON_2_RIGHT:
                ButtonMappings[j] = MY_DC_BUTTON_BOGUS;
                break;
            case MY_DC_BUTTON_2_DOWN:
                ButtonMappings[j] = MY_DC_BUTTON_BOGUS;
                break;
            case MY_DC_BUTTON_2_UP:
                ButtonMappings[j] = MY_DC_BUTTON_BOGUS;
                break;
            case MY_DC_BUTTON_RTRIGGER:
                ButtonMappings[j] = MY_DC_BUTTON_BOGUS;
                break;
            case MY_DC_BUTTON_LTRIGGER:
                ButtonMappings[j] = MY_DC_BUTTON_BOGUS;
                break;
            case MY_DC_BUTTON_AN3:
                ButtonMappings[j] = MY_DC_BUTTON_BOGUS;
                break;
            case MY_DC_BUTTON_AN4:
                ButtonMappings[j] = MY_DC_BUTTON_BOGUS;
                break;
            case MY_DC_BUTTON_AN5:
                ButtonMappings[j] = MY_DC_BUTTON_BOGUS;
                break;
            case MY_DC_BUTTON_AN6:
                ButtonMappings[j] = MY_DC_BUTTON_BOGUS;
                break;
            default:
                // Fine.
...
#ifdef DEBUG
                            {
                                ...
                                while (curdev) {
                                    ...
                                    while (pVMU != NULL) {
                                        ...
                                        if ((pVMU->type & MDT_CONTROLLER) != 0)
                                            SHARON("controller ");
                                        if ((pVMU->type & MDT_STORAGE) != 0)
                                            SHARON("storage ");
                                        if ((pVMU->type & MDT_LCD) != 0)
                                            SHARON("lcd ");
                                        if ((pVMU->type & MDT_TIMER) != 0)
                                            SHARON("timer ");
                                        if ((pVMU->type & MDT_AUDIO_IN) != 0)
                                            SHARON("audio-in ");
                                        if ((pVMU->type & MDT_LIGHTGUN) != 0)
                                            SHARON("lightgun ");
                                        if ((pVMU->type & MDT_VIBRATION) != 0)
                                            SHARON("vibration ");
