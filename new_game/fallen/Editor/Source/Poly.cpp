...
inline SLONG spans_might_intersect(struct Boint* new_span, struct Boint* old_span)
{
    ...
    */
    ...
    if ((new_span->RightZ <= old_span->LeftZ && new_span->RightZ <= old_span->RightZ) && (new_span->LeftZ <= old_span->LeftZ && new_span->LeftZ <= old_span->RightZ))
        return (1); // new behind old
...
#else
void RENDER_SETUP(UBYTE*, SLONG, SLONG, SLONG, SLONG);
#pragma aux RENDER_SETUP = "	rol	eax,16"            \
                           "	rol	ebx,16"            \
                           "	rol	ecx,16"            \
                           "	mov	dl,cl"             \
                           "	mov	cl,bl"             \
                           ...
                           "	mov	eax,ASMshade"      \
                           "	mov	ebx,ASMtx"         \
                           "	mov	ecx,ASMty" parm[edi][esi][eax][ebx][ecx] modify[eax ebx ecx edx]
//				value[eax]
#endif
...
#else
void RENDER_SETUP2(void);
#pragma aux RENDER_SETUP2 = "	rol	eax,16" \
                            "	rol	ebx,16" \
                            "	rol	ecx,16" \
                            "	mov	dl,cl"  \
                            "	mov	cl,bl"  \
                            "	mov	bl,al"  \
                            "	mov	al,dl"  \
                            "	xor	edx,edx" modify[eax ebx ecx edx]
#endif
...
#else
void RENDER_GO_GT(void);
#pragma aux RENDER_GO_GT = "	push	ebp"                \
                           "	mov	ebp,ASMtext_page"    \
                           "	lp:"                     \
                           "	add	eax,ASMstep_shade"   \
                           "	adc	ebx,ASMstep_tx"      \
                           ...
                           "	dec esi"                 \
                           "	jnz  lp"                 \
                           "	pop	ebp" modify[edi esi eax ebx ecx edx]
//				value[eax]
#endif
...
#else
void RENDER_GO_COL(void);
#pragma aux RENDER_GO_COL = "	mov	ecx,ASMCol" modify[ecx]
#endif
...
#pragma aux RENDER_GO_G = "	lp:"                     \
                          ...
                          "	mov [edi],dl"            \
                          "	dec esi"                 \
                          "	jnz  lp" modify[edi esi eax ebx ecx edx] value[eax]
#endif
...
#else
SLONG RENDER_GO_GT16(void);
#pragma aux RENDER_GO_GT16 = "	push	ebp"                \
                             "	mov	ebp,ASMtext_page"    \
                             "	lp:"                     \
                             "	add	eax,ASMstep_shade"   \
                             "	adc	ebx,ASMstep_tx"      \
                             ...
                             "	dec esi"                 \
                             "	jnz  lp"                 \
                             "	pop	ebp" modify[edi esi eax ebx ecx edx] value[eax]
#endif
...
#else
SLONG RENDER_GO_GT32(void);
#pragma aux RENDER_GO_GT32 = "	push	ebp"                 \
                             "	mov	ebp,ASMtext_page"     \
                             "	lp:"                      \
                             "	add	eax,ASMstep_shade"    \
                             "	adc	ebx,ASMstep_tx"       \
...
#else
SLONG RENDER_GO_TGT(void);
#pragma aux RENDER_GO_TGT = "	push	ebp"                 \
                            "	mov	ebp,ASMtext_page"     \
...
#else
SLONG RENDER_GO_TT(void);
#pragma aux RENDER_GO_TT = "	push	ebp"                 \
                           "	mov	ebp,ASMtext_page"     \
                           "lp:	add	eax,ASMstep_shade" \
                           "	adc	ebx,ASMstep_tx"       \
                           "	adc	ecx,ASMstep_ty"       \
...
#else
SLONG RENDER_GO_50GT(void);
#pragma aux RENDER_GO_50GT = "	push	ebp"                 \
                             "	mov	ebp,ASMtext_page"     \
                             "lp:	add	eax,ASMstep_shade" \
                             "	adc	ebx,ASMstep_tx"       \
                             "	adc	ecx,ASMstep_ty"       \
...
#else
SLONG RENDER_GO_50T(void);
#pragma aux RENDER_GO_50T = "	push	ebp"                 \
                            "	mov	ebp,ASMtext_page"     \
                            "lp:	add	eax,ASMstep_shade" \
                            "	adc	ebx,ASMstep_tx"       \
                            "	adc	ecx,ASMstep_ty"       \
...
#else
SLONG RENDER_GO_50MGT(void);
#pragma aux RENDER_GO_50MGT = "	push	ebp"                \
                              "	mov	ebp,ASMtext_page"    \
                              "	lp:"                     \
                              "	add	eax,ASMstep_shade"   \
                              "	adc	ebx,ASMstep_tx"      \
...
#pragma aux RENDER_GO_MGT = "	push	ebp"                \
                            "	mov	ebp,ASMtext_page"    \
                            "	lp:"                     \
                            "	add	eax,ASMstep_shade"   \
                            "	adc	ebx,ASMstep_tx"      \
...
#pragma aux RENDER_GO_MT = "	push	ebp"              \
                           "	mov	ebp,ASMtext_page"  \
                           "	lp:"                   \
                           "	add	eax,ASMstep_shade" \
                           "	adc	ebx,ASMstep_tx"    \
...
#else
SLONG RENDER_GO_T(void);
#pragma aux RENDER_GO_T = "	push	ebp"              \
                          "	mov	ebp,ASMtext_page"  \
                          "	lp:"                   \
                          "	add	eax,ASMstep_shade" \
                          "	adc	ebx,ASMstep_tx"    \
...
#else
SLONG RENDER_GO_AMT(void);
#pragma aux RENDER_GO_AMT = "	push	ebp"                \
                            "	mov	ebp,ASMtext_page"    \
                            "	lp:"                     \
                            "	add	eax,ASMstep_shade"   \
                            "	adc	ebx,ASMstep_tx"      \
...
#else
SLONG RENDER_GO_AT(void);
#pragma aux RENDER_GO_AT = "	push	ebp"                \
                           "	mov	ebp,ASMtext_page"    \
                           "	lp:"                     \
                           "	add	eax,ASMstep_shade"   \
                           "	adc	ebx,ASMstep_tx"      \
...
void my_trig(struct MfEnginePoint* p3, struct MfEnginePoint* p2, struct MfEnginePoint* p1)
{
    ...
    if (p2->Y < p1->Y && p2->Y <= p3->Y) { // p2 is at top
    ...
    // now scan the edges and render between edges
    {
        ...
        if (count != 0) // if not flat top
        {
            if (poly.Y < 0) // if clipped off top of screen
            {
                ...
                if (count >= poly.Y) { // will be on screen before this count finishes
