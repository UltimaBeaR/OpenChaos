...
*/
#define RGB_TO_RGB565(r, g, b) ((UWORD)the_display.GetFormattedPixel(r, g, b))
#define RGB_TO_RGB888(r, g, b) ((r << 16) | (g << 8) | (b))
#define COL_TO_RGB565(col, PALETTE) ((UWORD)the_display.GetFormattedPixel(PALETTE[(col) * 3], PALETTE[(col) * 3 + 1], PALETTE[(col) * 3 + 2]))
#define COL_TO_RGB888(col, PALETTE) ((PALETTE[(col) * 3] << 16) | (PALETTE[(col) * 3 + 1] << 8) | PALETTE[(col) * 3 + 2])
