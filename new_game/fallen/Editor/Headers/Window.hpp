...
public:
    ...
    inline void SetControlsWidth(UWORD width)
    {
        ControlAreaWidth = width;
        SetAreaSizes();
    }
    inline void SetControlsHeight(UWORD height)
    {
        ControlAreaHeight = height;
        SetAreaSizes();
    }
    ...
    inline MFPoint* GlobalToLocal(MFPoint* the_point)
    {
        the_point->X -= ContentRect.GetLeft();
        the_point->Y -= ContentRect.GetTop();
        return the_point;
    }
    inline MFPoint* LocalToGlobal(MFPoint* the_point)
    {
        the_point->X += ContentRect.GetLeft();
        the_point->Y += ContentRect.GetTop();
        return the_point;
