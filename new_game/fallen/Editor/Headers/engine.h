...
#define setShade4(p, s1, s2, s3, s4) \
    (p)->P[0].Shade = (SWORD)(s1);   \
    (p)->P[1].Shade = (SWORD)(s2);   \
    (p)->P[2].Shade = (SWORD)(s3);   \
    (p)->P[3].Shade = (SWORD)(s4)
...
#define setPoly50MGT4(p)                           \
    ...
    ((struct BucketQuad*)p)->DrawFlags = (POLY_FLAG_SEMI_TRANS | POLY_FLAG_MASKED | POLY_FLAG_GOURAD | POLY_FLAG_TEXTURED)
#define setPoly50MGT3(p)                         \
    ((struct BucketTri*)p)->BucketType = BT_TRI; \
    ((struct BucketTri*)p)->DrawFlags = (POLY_FLAG_SEMI_TRANS | POLY_FLAG_MASKED | POLY_FLAG_GOURAD | POLY_FLAG_TEXTURED)
#define setPoly50GT4(p)                            \
    ((struct BucketQuad*)p)->BucketType = BT_QUAD; \
    ((struct BucketQuad*)p)->DrawFlags = (POLY_FLAG_SEMI_TRANS | POLY_FLAG_GOURAD | POLY_FLAG_TEXTURED)
#define setPoly50GT3(p)                          \
    ((struct BucketTri*)p)->BucketType = BT_TRI; \
    ((struct BucketTri*)p)->DrawFlags = (POLY_FLAG_SEMI_TRANS | POLY_FLAG_GOURAD | POLY_FLAG_TEXTURED)
#define setPoly50T4(p)                             \
    ((struct BucketQuad*)p)->BucketType = BT_QUAD; \
    ((struct BucketQuad*)p)->DrawFlags = (POLY_FLAG_SEMI_TRANS | POLY_FLAG_TEXTURED)
#define setPoly50T3(p)                           \
    ((struct BucketTri*)p)->BucketType = BT_TRI; \
    ((struct BucketTri*)p)->DrawFlags = (POLY_FLAG_SEMI_TRANS | POLY_FLAG_TEXTURED)
#define setPoly50G4(p)                             \
    ((struct BucketQuad*)p)->BucketType = BT_QUAD; \
    ((struct BucketQuad*)p)->DrawFlags = (POLY_FLAG_SEMI_TRANS | POLY_FLAG_GOURAD)
#define setPoly50G3(p)                           \
    ((struct BucketTri*)p)->BucketType = BT_TRI; \
    ((struct BucketTri*)p)->DrawFlags = (POLY_FLAG_SEMI_TRANS | POLY_FLAG_GOURAD)
#define setPoly50F4(p)                             \
    ((struct BucketQuad*)p)->BucketType = BT_QUAD; \
    ((struct BucketQuad*)p)->DrawFlags = (POLY_FLAG_SEMI_TRANS)
#define setPoly50F3(p)                           \
    ((struct BucketTri*)p)->BucketType = BT_TRI; \
    ((struct BucketTri*)p)->DrawFlags = (POLY_FLAG_SEMI_TRANS)

#define setPolyAMT4(p)                             \
    ((struct BucketQuad*)p)->BucketType = BT_QUAD; \
    ((struct BucketQuad*)p)->DrawFlags = (POLY_FLAG_ALPHA | POLY_FLAG_MASKED | POLY_FLAG_TEXTURED)
#define setPolyAMT3(p)                           \
    ((struct BucketTri*)p)->BucketType = BT_TRI; \
    ((struct BucketTri*)p)->DrawFlags = (POLY_FLAG_ALPHA | POLY_FLAG_MASKED | POLY_FLAG_TEXTURED)
#define setPolyAG4(p)                              \
    ((struct BucketQuad*)p)->BucketType = BT_QUAD; \
    ((struct BucketQuad*)p)->DrawFlags = (POLY_FLAG_ALPHA | POLY_FLAG_GOURAD)
#define setPolyAG3(p)                            \
    ((struct BucketTri*)p)->BucketType = BT_TRI; \
    ((struct BucketTri*)p)->DrawFlags = (POLY_FLAG_ALPHA | POLY_FLAG_GOURAD)
#define setPolyAT4(p)                              \
    ((struct BucketQuad*)p)->BucketType = BT_QUAD; \
    ((struct BucketQuad*)p)->DrawFlags = (POLY_FLAG_ALPHA | POLY_FLAG_TEXTURED)
#define setPolyAT3(p)                            \
    ((struct BucketTri*)p)->BucketType = BT_TRI; \
    ((struct BucketTri*)p)->DrawFlags = (POLY_FLAG_ALPHA | POLY_FLAG_TEXTURED)

#define setPolyTGT4(p)                             \
    ((struct BucketQuad*)p)->BucketType = BT_QUAD; \
    ((struct BucketQuad*)p)->DrawFlags = (POLY_FLAG_TILED | POLY_FLAG_GOURAD | POLY_FLAG_TEXTURED)
#define setPolyTGT3(p)                           \
    ((struct BucketTri*)p)->BucketType = BT_TRI; \
    ((struct BucketTri*)p)->DrawFlags = (POLY_FLAG_TILED | POLY_FLAG_GOURAD | POLY_FLAG_TEXTURED)

#define setPolyMGT4(p)                             \
    ((struct BucketQuad*)p)->BucketType = BT_QUAD; \
    ((struct BucketQuad*)p)->DrawFlags = (POLY_FLAG_MASKED | POLY_FLAG_GOURAD | POLY_FLAG_TEXTURED)
#define setPolyMGT3(p)                           \
    ((struct BucketTri*)p)->BucketType = BT_TRI; \
    ((struct BucketTri*)p)->DrawFlags = (POLY_FLAG_MASKED | POLY_FLAG_GOURAD | POLY_FLAG_TEXTURED)
#define setPolyGT4(p)                              \
    ((struct BucketQuad*)p)->BucketType = BT_QUAD; \
    ((struct BucketQuad*)p)->DrawFlags = (POLY_FLAG_GOURAD | POLY_FLAG_TEXTURED)
#define setPolyGT3(p)                            \
    ((struct BucketTri*)p)->BucketType = BT_TRI; \
    ((struct BucketTri*)p)->DrawFlags = (POLY_FLAG_GOURAD | POLY_FLAG_TEXTURED)
#define setPolyMT4(p)                              \
    ((struct BucketQuad*)p)->BucketType = BT_QUAD; \
    ((struct BucketQuad*)p)->DrawFlags = (POLY_FLAG_MASKED | POLY_FLAG_TEXTURED)
#define setPolyMT3(p)                            \
    ((struct BucketTri*)p)->BucketType = BT_TRI; \
    ((struct BucketTri*)p)->DrawFlags = (POLY_FLAG_MASKED | POLY_FLAG_TEXTURED)
#define setPolyT4(p)                               \
    ((struct BucketQuad*)p)->BucketType = BT_QUAD; \
    ((struct BucketQuad*)p)->DrawFlags = (POLY_FLAG_TEXTURED)
#define setPolyT3(p)                             \
    ((struct BucketTri*)p)->BucketType = BT_TRI; \
    ((struct BucketTri*)p)->DrawFlags = (POLY_FLAG_TEXTURED)
#define setPolyG4(p)                               \
    ((struct BucketQuad*)p)->BucketType = BT_QUAD; \
    ((struct BucketQuad*)p)->DrawFlags = (POLY_FLAG_GOURAD)
#define setPolyG3(p)                             \
    ((struct BucketTri*)p)->BucketType = BT_TRI; \
    ((struct BucketTri*)p)->DrawFlags = (POLY_FLAG_GOURAD)
#define setPolyF4(p)                               \
    ((struct BucketQuad*)p)->BucketType = BT_QUAD; \
    ((struct BucketQuad*)p)->DrawFlags = (0)
#define setPolyF3(p)                             \
    ((struct BucketTri*)p)->BucketType = BT_TRI; \
    ((struct BucketTri*)p)->DrawFlags = (0)
#define setPolyGVect(p)                            \
    ((struct BucketVect*)p)->BucketType = BT_VECT; \
    ((struct BucketVect*)p)->DrawFlags = 0

#define setPolyType3(p, type)                    \
    ((struct BucketTri*)p)->BucketType = BT_TRI; \
    ((struct BucketTri*)p)->DrawFlags = (type)
#define setPolyType4(p, type)                      \
    ((struct BucketQuad*)p)->BucketType = BT_QUAD; \
    ((struct BucketQuad*)p)->DrawFlags = (type)

#define setRect(p)                                 \
    ((struct BucketQuad*)p)->BucketType = BT_RECT; \
    ((struct BucketQuad*)p)->DrawFlags = 0
