...
public:
    ...
    void DrawControl(void);
    inline CBYTE* SetString1(CBYTE* the_string)
    {
        strncpy(String1, the_string, EDIT_TEXT_LENGTH);
        String1[EDIT_TEXT_LENGTH - 1] = 0;
        return String1;
    }
    inline CBYTE* SetString2(CBYTE* the_string)
    {
        strncpy(String2, the_string, EDIT_TEXT_LENGTH);
        String2[EDIT_TEXT_LENGTH - 1] = 0;
        return String2;
    }
};
...
public:
    ...
    inline CBYTE* SetEditString(CBYTE* the_string)
    {
        strcpy(EditText, the_string);
        return EditText;
    }
};
...
public:
    ...
    inline void SetValueRange(SLONG min, SLONG max)
    {
        MinValue = min;
        MaxValue = max;
        SetupDrag();
