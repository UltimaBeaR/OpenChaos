...
void PANEL_new_funky_do(SLONG which, SLONG where)
{
...

    {
        ...
        if (darci->Genus.Person->SpecialUse) {
            ...
            if (p_special->Genus.Special->SpecialType == SPECIAL_GRENADE && p_special->SubState == SPECIAL_SUBSTATE_ACTIVATED) {
                //
...

    {
        ...
        case 1:
            danger_colour = 0xffff0000;
            break;
        case 2:
            danger_colour = 0xffffdd00;
            break;
        case 3:
            danger_colour = 0xff00dd00;
            break;
