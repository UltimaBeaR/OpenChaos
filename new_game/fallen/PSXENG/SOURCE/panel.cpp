...
void PANEL_inventory(Thing* darci)
{
    ...
    if (darci->Genus.Person->SpecialList) {
        ...
        while (p_special) {
            ...
            if (SPECIAL_info[p_special->Genus.Special->SpecialType].group == SPECIAL_GROUP_ONEHANDED_WEAPON || SPECIAL_info[p_special->Genus.Special->SpecialType].group == SPECIAL_GROUP_TWOHANDED_WEAPON || p_special->Genus.Special->SpecialType == SPECIAL_EXPLOSIVES) {
