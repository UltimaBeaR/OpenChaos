...
void set_light_matrix(MATRIX* comb_matrix_local)
{
    ...
    light_dir.m[0][0] = 4095;
    light_dir.m[0][1] = -4095;
    light_dir.m[0][2] = -4095;
    light_dir.m[1][0] = 0;
    light_dir.m[1][1] = 4095;
    light_dir.m[1][2] = 0;
    light_dir.m[2][0] = 0;
    light_dir.m[2][1] = 0;
    light_dir.m[2][2] = 0;
...
SLONG get_sort_z_bodge(SLONG px, SLONG pz, Thing* p_thing)
{
    ...
    if ((p_thing->SubState == SUB_STATE_DANGLING) || (p_thing->SubState == SUB_STATE_PULL_UP) || (p_thing->SubState == SUB_STATE_GRAB_TO_DANGLE) || (p_thing->SubState == SUB_STATE_TRAVERSE_LEFT) || (p_thing->SubState == SUB_STATE_TRAVERSE_RIGHT) || (p_thing->State == STATE_CLIMB_LADDER)) {
        SLONG dangle;
        ...
        if (1) {
            MATRIX temp_matrix;
            {
                ...
                if (dx < (7 << 8)) {
                    ...
                    temp_matrix.m[0][0] = 2095;
                    temp_matrix.m[0][1] = 3000;
                    temp_matrix.m[0][2] = 0;
                    temp_matrix.m[1][0] = 3095;
                    temp_matrix.m[1][1] = 0;
                    temp_matrix.m[1][2] = 0;
                    temp_matrix.m[2][0] = 1000;
                    temp_matrix.m[2][1] = 0;
                    temp_matrix.m[2][2] = 0;
