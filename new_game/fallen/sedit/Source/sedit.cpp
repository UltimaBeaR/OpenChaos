...
void SEDIT_set_state_look()
{
    ...
    switch (SEDIT_tool) {
    case SEDIT_TOOL_PLACE_SEWERS:
        tool_name = "Place sewers";
        break;
    case SEDIT_TOOL_PLACE_GROUND:
        tool_name = "Place ground";
        break;
    case SEDIT_TOOL_PLACE_ROCK:
        tool_name = "Place rock";
        break;
    case SEDIT_TOOL_PLACE_WATER:
        tool_name = "Place water";
        break;
    case SEDIT_TOOL_PLACE_HOLE:
        tool_name = "Place hole";
        break;
    case SEDIT_TOOL_PLACE_ENTRANCE:
        tool_name = "Place entrance";
        break;
    case SEDIT_TOOL_PLACE_GRATING:
        tool_name = "Place grating";
        break;
    case SEDIT_TOOL_PLACE_PRIM:
        tool_name = "Place prim (Doens't work yet)";
        break;
    case SEDIT_TOOL_PLACE_LADDER:
        tool_name = "Place ladder";
        break;
    case SEDIT_TOOL_EDIT_LIGHT:
        tool_name = "Edit light";
        break;
    default:
        tool_name = "";
        break;
    ...
    if (!SEDIT_map_valid) {
        ...
        switch (SEDIT_tool) {
        case SEDIT_TOOL_PLACE_SEWERS:
            CheckMenuItem(SEDIT_main_menu, ID_EDIT_PLACE_SEWERS, MF_CHECKED);
            break;
        case SEDIT_TOOL_PLACE_GROUND:
            CheckMenuItem(SEDIT_main_menu, ID_EDIT_PLACE_GROUND, MF_CHECKED);
            break;
        case SEDIT_TOOL_PLACE_ROCK:
            CheckMenuItem(SEDIT_main_menu, ID_EDIT_PLACE_ROCK, MF_CHECKED);
            break;
        case SEDIT_TOOL_PLACE_WATER:
            CheckMenuItem(SEDIT_main_menu, ID_EDIT_PLACE_WATER, MF_CHECKED);
            break;
        case SEDIT_TOOL_PLACE_HOLE:
            CheckMenuItem(SEDIT_main_menu, ID_EDIT_PLACE_HOLE, MF_CHECKED);
            break;
        case SEDIT_TOOL_PLACE_ENTRANCE:
            CheckMenuItem(SEDIT_main_menu, ID_EDIT_PLACE_ENTRANCE, MF_CHECKED);
            break;
        case SEDIT_TOOL_PLACE_GRATING:
            CheckMenuItem(SEDIT_main_menu, ID_EDIT_PLACE_GRATING, MF_CHECKED);
            break;
        case SEDIT_TOOL_PLACE_PRIM:
            CheckMenuItem(SEDIT_main_menu, ID_EDIT_PLACE_PRIM, MF_CHECKED);
            break;
        case SEDIT_TOOL_PLACE_LADDER:
            CheckMenuItem(SEDIT_main_menu, ID_EDIT_PLACE_LADDER, MF_CHECKED);
            break;
        case SEDIT_TOOL_EDIT_LIGHT:
            CheckMenuItem(SEDIT_main_menu, ID_EDIT_EDIT_LIGHT, MF_CHECKED);
            break;
        ...
        case SEDIT_VIEW_TYPE_SEWERS:
            CheckMenuItem(SEDIT_main_menu, ID_VIEW_SEWER_ENGINE, MF_CHECKED);
            break;
        case SEDIT_VIEW_TYPE_EDITOR:
            CheckMenuItem(SEDIT_main_menu, ID_VIEW_SEWER_EDITOR, MF_CHECKED);
            break;
        case SEDIT_VIEW_TYPE_ENGINE:
            CheckMenuItem(SEDIT_main_menu, ID_VIEW_CITY_ENGINE, MF_CHECKED);
            break;
...
void SEDIT_process(void)
{
    ...
    case SEDIT_VIEW_TYPE_EDITOR:
        ...
        if (WITHIN(SEDIT_cam_focus_x >> 8, 0, PAP_SIZE_HI - 1) && WITHIN(SEDIT_cam_focus_z >> 8, 0, PAP_SIZE_HI - 1)) {
    ...
    case SEDIT_VIEW_TYPE_ENGINE:
        ...
        if (WITHIN(mouse.x, clientrect.left, clientrect.right) && WITHIN(mouse.y, clientrect.top, clientrect.bottom)) {
        ...
        if (SEDIT_mouse_valid) {
            if (SEDIT_view_type == SEDIT_VIEW_TYPE_ENGINE) {
                ...
                case SEDIT_DOING_NOTHING:
                    ...
                    switch (SEDIT_tool) {
                    case SEDIT_TOOL_PLACE_SEWERS:
                        SEDIT_doing = SEDIT_DOING_PAINT_SEWERS;
                        break;
                    case SEDIT_TOOL_PLACE_GROUND:
                        SEDIT_doing = SEDIT_DOING_PAINT_GROUND;
                        break;
                    case SEDIT_TOOL_PLACE_ROCK:
                        SEDIT_doing = SEDIT_DOING_PAINT_ROCK;
                        break;
                    case SEDIT_TOOL_PLACE_HOLE:
                        SEDIT_doing = SEDIT_DOING_PAINT_HOLE;
                        break;
                    case SEDIT_TOOL_PLACE_WATER:
    ...
    case WM_MOUSEMOVE:
        ...
        if (SEDIT_mouse_valid) {
            if (SEDIT_view_type == SEDIT_VIEW_TYPE_ENGINE) {
                ...
                switch (SEDIT_doing) {
                case SEDIT_DOING_PAINT_SEWERS:
                    eh->type = ES_TYPE_SEWER;
                    break;
                case SEDIT_DOING_PAINT_GROUND:
                    eh->type = ES_TYPE_GROUND;
                    break;
                case SEDIT_DOING_PAINT_ROCK:
                    eh->type = ES_TYPE_ROCK;
                    break;
                case SEDIT_DOING_PAINT_HOLE:
                    eh->type = ES_TYPE_HOLE;
                    break;
