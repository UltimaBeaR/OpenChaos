...
_FUNC(int)
MIDASgetLastError(void);
_FUNC(char*)
MIDASgetErrorMessage(int errorCode);

_FUNC(DWORD)
MIDASgetDisplayRefreshRate(void);
...
_FUNC(BOOL)
MIDASremoveTimerCallbacks(void);

_FUNC(DWORD)
MIDASallocateChannel(void);
_FUNC(BOOL)
...
_FUNC(BOOL)
MIDASfreeAutoEffectChannels(void);
