                ...
                default:
                    ...
                    if (tpCur != NULL) {
                        ...
                        for (int iWC = 0; iWC < NUM_WCS; iWC++) {
                            ...
                            case WCW_OFFSET:
                                wcBase[iWC].fOffset = fValue;
                                break;
                            case WCW_COS1AMP:
                                wcBase[iWC].fCos1Amp = fValue;
                                break;
                            case WCW_COS1OFF:
                                wcBase[iWC].fCos1Off = fValue;
                                break;
                            case WCW_COS1POS:
                                wcBase[iWC].fCos1Pos = fValue;
                                break;
                            case WCW_COS1INC:
                                wcBase[iWC].fCos1Inc = fValue;
                                break;
                            case WCW_COS2AMP:
                                wcBase[iWC].fCos2Amp = fValue;
                                break;
                            case WCW_COS2OFF:
                                wcBase[iWC].fCos2Off = fValue;
                                break;
                            case WCW_COS2POS:
                                wcBase[iWC].fCos2Pos = fValue;
                                break;
                            case WCW_COS2INC:
                                wcBase[iWC].fCos2Inc = fValue;
                                break;
                            case WCW_RAMPTIME:
                                wcBase[iWC].fRampTime = fValue;
                                break;
                            case WCW_RAMPTIMEINC:
                                wcBase[iWC].fRampTimeInc = fValue;
                                break;
                            case WCW_RAMPUPSTART:
                                wcBase[iWC].fRampUpStart = fValue;
                                break;
                            case WCW_RAMPUPEND:
                                wcBase[iWC].fRampUpEnd = fValue;
                                break;
                            case WCW_RAMPMIDVALUE:
                                wcBase[iWC].fRampMidValue = fValue;
                                break;
                            case WCW_RAMPDOWNSTART:
                                wcBase[iWC].fRampDownStart = fValue;
                                break;
                            case WCW_RAMPDOWNEND:
                                wcBase[iWC].fRampDownEnd = fValue;
                                break;
                            case WCW_RAMPBASEVALUE:
                                wcBase[iWC].fRampBaseValue = fValue;
                                break;
                            default:
                                ASSERT(FALSE);
                                break;
