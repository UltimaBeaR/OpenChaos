...
#define FLAG_ZL (1 << 3)
                ...
                if (NS_HI_TYPE(&NS_hi[x + 1][z]) == NS_HI_TYPE_SEWER) {
                    flag |= FLAG_XS;
                }
                if (NS_HI_TYPE(&NS_hi[x - 1][z]) == NS_HI_TYPE_SEWER) {
                    flag |= FLAG_XL;
                }
                if (NS_HI_TYPE(&NS_hi[x][z + 1]) == NS_HI_TYPE_SEWER) {
                    flag |= FLAG_ZS;
                }
                if (NS_HI_TYPE(&NS_hi[x][z - 1]) == NS_HI_TYPE_SEWER) {
                    flag |= FLAG_ZL;
                ...
                switch (flag) {
                case FLAG_XS:
                    curve = NS_HI_CURVE_XS;
                    break;
                case FLAG_XL:
                    curve = NS_HI_CURVE_XL;
                    break;
                case FLAG_ZS:
                    curve = NS_HI_CURVE_ZS;
                    break;
                case FLAG_ZL:
                    curve = NS_HI_CURVE_ZL;
                    break;

                case FLAG_XS | FLAG_ZS:
                    curve = NS_HI_CURVE_ASS;
                    break;
                case FLAG_XL | FLAG_ZS:
                    curve = NS_HI_CURVE_ALS;
                    break;
                case FLAG_XS | FLAG_ZL:
                    curve = NS_HI_CURVE_ASL;
                    break;
                case FLAG_XL | FLAG_ZL:
                    curve = NS_HI_CURVE_ALL;
                    break;
                }
                ...
                if (curve == -1) {
                    ...
                    if (NS_HI_TYPE(&NS_hi[x + 1][z + 1]) == NS_HI_TYPE_SEWER) {
                        curve = NS_HI_CURVE_OSS;
                    }
                    if (NS_HI_TYPE(&NS_hi[x - 1][z + 1]) == NS_HI_TYPE_SEWER) {
                        curve = NS_HI_CURVE_OLS;
                    }
                    if (NS_HI_TYPE(&NS_hi[x + 1][z - 1]) == NS_HI_TYPE_SEWER) {
                        curve = NS_HI_CURVE_OSL;
                    }
                    if (NS_HI_TYPE(&NS_hi[x - 1][z - 1]) == NS_HI_TYPE_SEWER) {
                        curve = NS_HI_CURVE_OLL;
                    }
                }
