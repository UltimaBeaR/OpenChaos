...
SLONG add_dfacet(SLONG x1, SLONG z1, SLONG x2, SLONG z2, SLONG y, SLONG count, SLONG style_index, SLONG storey_type, SLONG facet_flags, SLONG offsety, SLONG block_height)
{
    ...
    */
    ...
    } else if (p_facet->FacetType == STOREY_TYPE_FENCE_FLAT || p_facet->FacetType == STOREY_TYPE_FENCE || p_facet->FacetType == STOREY_TYPE_FENCE_BRICK || p_facet->FacetType == STOREY_TYPE_OUTSIDE_DOOR) {
