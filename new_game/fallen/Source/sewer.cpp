        ...
        for (z = 0; z < SEWER_SIZE; z++) {
            if (SEWER_square[x][z] == SEWER_TYPE_OFF) {
                ...
                for (i = 0; i < 4; i++) {
                    ...
                    if (WITHIN(nx, 0, SEWER_SIZE - 1) && WITHIN(nz, 0, SEWER_SIZE - 1)) {
                ...
                switch (on) {
                case 0:
                    SEWER_square[x][z] = SEWER_TYPE_OFF;
                    break;
                case 1:
                    SEWER_square[x][z] = SEWER_TYPE_WALL_XS;
                    break;
                case 2:
                    SEWER_square[x][z] = SEWER_TYPE_WALL_XL;
                    break;
                case 4:
                    SEWER_square[x][z] = SEWER_TYPE_WALL_ZS;
                    break;
                case 8:
                    SEWER_square[x][z] = SEWER_TYPE_WALL_ZL;
                    break;
                case 1 | 4:
                    SEWER_square[x][z] = SEWER_TYPE_WALL_CSS;
                    break;
                case 1 | 8:
                    SEWER_square[x][z] = SEWER_TYPE_WALL_CSL;
                    break;
                case 2 | 4:
                    SEWER_square[x][z] = SEWER_TYPE_WALL_CLS;
                    break;
                case 2 | 8:
                    SEWER_square[x][z] = SEWER_TYPE_WALL_CLL;
                    break;
                }
            }
        }
    ...
    for (x = 0; x < SEWER_SIZE; x++)
        for (z = 0; z < SEWER_SIZE; z++) {
            if (SEWER_square[x][z] == SEWER_TYPE_OFF) {
                ...
                switch (on) {
                case 1:
                    SEWER_square[x][z] = SEWER_TYPE_WALL_PSS;
                    break;
                case 2:
                    SEWER_square[x][z] = SEWER_TYPE_WALL_PLS;
                    break;
                case 4:
                    SEWER_square[x][z] = SEWER_TYPE_WALL_PSL;
                    break;
                case 8:
                    SEWER_square[x][z] = SEWER_TYPE_WALL_PLL;
                    break;
                }
            }
        }
...
{
    if (WITHIN(x, 0, SEWER_SIZE - 1) && WITHIN(z, 0, SEWER_SIZE - 1)) {
...
#define SEWER_PILLAR_CURVE 0x20
    ...
    if (!SEWER_got_wall) {
        if (SEWER_got_wall1_count == 0 && SEWER_got_wall2_count == 0) {
            SLONG x[5];
            SLONG y[5];
            SLONG z[5];
            SLONG u[4];
