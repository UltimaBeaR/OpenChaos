...
void PIGEON_fn_normal(Thing* pigeon)
{
    ...
    case PIGEON_SUBSTATE_NONE:
        break;
    case PIGEON_SUBSTATE_WAIT:
        PIGEON_process_wait(pigeon);
        break;
    case PIGEON_SUBSTATE_PECK:
        PIGEON_process_peck(pigeon);
        break;
    case PIGEON_SUBSTATE_WALK:
        PIGEON_process_walk(pigeon);
        break;
    case PIGEON_SUBSTATE_FLEE:
        PIGEON_process_flee(pigeon);
        break;
    case PIGEON_SUBSTATE_FLY:
        PIGEON_process_fly(pigeon);
        break;
    case PIGEON_SUBSTATE_PERCH:
        PIGEON_process_perch(pigeon);
        break;
