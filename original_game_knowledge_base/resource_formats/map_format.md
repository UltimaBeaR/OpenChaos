...
| PAP_Lo (32×32, 8 байт/ячейка) | runtime only | Строится при загрузке, не читается |
| LoadGameThing | 1:1 | Для анимированных примов |
| SuperMap (DBuilding, DFacet) | 1:1 | Здания и коллизии |
| InsideStorey / Staircase | 1:1 | Интерьеры |
