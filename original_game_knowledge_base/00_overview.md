...
**Файлы:** `Vehicle.cpp`, `Vehicle.h`, `bike.cpp`

- Автомобили — только NPC (игрок не управляет)
- Мотоциклы (`bike.cpp`, флаг `BIKE`) — может управлять игрок (см. BIKE в препроцессорных флагах)
- Модель повреждений с визуальной деформацией
- Физика на основе коллизий
...
- **Мотоцикл** (`bike.cpp`, флаг `BIKE`) — код есть, в финале не вошёл (проверить)
