...
- **ПЕРЕНОСИТЬ:** find_grab_face (двухпроходный поиск), cable физику, ladder механику
- **Cable параметры:** нужно сохранить кодирование в DFacet (или сделать отдельную структуру)
- **valid_grab_angle():** в оригинале отключена → можно оставить как есть или реализовать
- **Канализация:** НЕ переносить (sewers = cut feature)
- **calc_sub_objects_position:** перенести (нужно для хватания/позиционирования)
