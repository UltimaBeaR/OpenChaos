...
`INSIDE2_mav_nav_calc(inside)` — **весь блок в `#if 0`** (строки 793-1195 inside2.cpp). Строит 2D nav-сетку здания:
...
Заметки по переносу навигации → `new_game_planning/porting_notes.md`
