...
```
[254 байта] UBYTE SkillLevels[254]     — AI skill per person type (читает ELEV_load_level)
[1 байт]    UBYTE BoredomRate
[1 байт]    UBYTE CarsRate
[1 байт]    UBYTE MusicWorld
```

Итого полный .ucm: **≈1316 + 37888 + 256 ≈ 39 460 байт** (плюс возможные дополнительные данные).
