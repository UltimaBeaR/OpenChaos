...
- В пре-релизных исходниках аналог только эмулирует D-Pad (нет плавного движения)
- **Примечание:** в финальном релизе PS1 плавное аналоговое управление **есть** (подтверждено на эмуляторе):
  малое отклонение стика = шаг, полное = бег. Также в аналоговом режиме D-Pad отключается полностью.
  Эта функциональность была доработана после заморозки пре-релизных исходников.
