...
**id.cpp рендеринг интерьеров, ID_generate_floorplan, WARE склады:** → [buildings_interiors_details.md](buildings_interiors_details.md)
...
- STOREY_TYPE_CABLE (тип 9) — тросы/death-slide — есть в финальной игре.
- Навигация в складах (WARE_mav_*) и интерьерах (INSIDE2_mav_*) — детали в [navigation.md](navigation.md).
