...
**Перенос:** ❓ **СПРОСИТЬ ПОЛЬЗОВАТЕЛЯ: воздушные шары есть в финальной PC/PS1 версии?** Если нет → не переносить.
...
**КРИТИЧНО для портирования:** `drawxtra.cpp` содержит игровую логику внутри функций рисования.
