...
- После значительных изменений в нескольких KB файлах (итерация консистентности / верификации)
- Если DENSE_SUMMARY содержит устаревшие числа или факты
- После добавления новых подсистем в KB
- **НЕ пересобирать** при мелких правках одного файла — проще обновить нужную секцию вручную
