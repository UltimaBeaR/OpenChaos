...
|-------|--------|-------------|
| Чит-загрузка миссии по номеру | ⏳ | Debug-режим: комбинация клавиш → ввод номера миссии → загрузка. Для отладки — чтобы не проходить игру заново ради доступа к поздним миссиям |
