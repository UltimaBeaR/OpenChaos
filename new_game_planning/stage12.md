...
- DualSense: LED-панель, вибрация, adaptive triggers — полностью отлажены, без глюков. Игровые доработки до 1.0:
  ...
  - Envelope-based вибрация при выстрелах (упрощённый подход: огибающая WAV → рамбл-моторы; не путать с полноценным audio-haptic через HID 0x32 который в либе отложен post-1.0)
