...
| Газетки не отображаются | На 1 миссии (Driving Bronze, полицейская машинка и мент) на земле должны быть листья вперемешку с газетками. В нашей версии газеток нет. В релизной PC-версии газетки видны. Неизвестно были ли они в нашей D3D6 версии до удаления — нужно проверить, рисуются ли они вообще и почему не видны. | Исследовать (сравнено с оригиналом) |
| Сломанные UV у некоторых листьев | На 1 миссии часть листьев рисуется с нормальными UV, а часть — с явно битыми UV координатами (текстура разъехавшаяся). В релизной PC-версии все листья рисуются корректно. Отдельный баг от газеток — затрагивает только часть leaf-геометрии. | Исследовать (сравнено с оригиналом) |
