...
| Листья и трупы рисуются поверх огня/взрывов/света | Листья (POLY_PAGE_LEAF) и трупы людей отображаются перед взрывами и огнём, не перекрываются ими. Хорошо видно на Urban Shakedown — в начале горит полицейский участок, листья и лежащие трупы не затрагиваются визуалом огня. Также проявляется на 1 миссии — свет фонарика не учитывает листья на земле: листья рисуются поверх конуса света фонаря. При этом на модельки (мент, машина) свет фонарика влияет нормально. Взрывы в целом рисуются странно. Вероятно общая проблема с порядком отрисовки листьев/частиц относительно аддитивных эффектов (огонь, свет). Нужно проверить как это выглядит в релизной PC-версии и в D3D6 — возможно так и было в оригинале. | Исследовать (сверить с оригиналом) |
