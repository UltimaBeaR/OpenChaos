...
|----------|----------|--------|
| Маппинг кнопок в авто не соответствует PS1 | Сейчас: Square=вперёд, Cross=мигалки. На PS1: **Cross=вперёд, Square=назад, Triangle=мигалка, L2/R2=камера** (камера пешком и в авто — L2/R2 совпадает). Стик: вперёд=газ, назад=задний ход, влево/вправо=руль — **совпадает** с PS1. Крестовина: на PS1 в аналоговом режиме влево/вправо отключены (вперёд/назад работают), у нас работают все направления — повторять PS1 ограничение не будем. | Исправить (перед итерацией B) |
