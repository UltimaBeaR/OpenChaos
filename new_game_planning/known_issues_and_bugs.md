...
| Тормоза при вступительной катсцене миссии | При загрузке миссии во время вступительной катсцены (камера показывает локации, чёрные полосы, текст с описанием миссии) — FPS падает до ~1 кадра в несколько секунд. После окончания катсцены производительность возвращается в норму. Не стабильно воспроизводится — при рестарте уровня и перезапуске игры может не проявиться. Замечено 2026-04-05, возможно плавающий баг. | Исследовать |
