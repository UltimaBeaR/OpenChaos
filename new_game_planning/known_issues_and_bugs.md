...
| Неправильный порядок отрисовки объектов (лежаки, кусты, мебель) | Скорее всего проблема с порядком отрисовки, а не z-buffer. Проявляется на нескольких миссиях: **(1) Estate of Emergency** — у пустого бассейна с аптечкой лежаки (lounge chairs): листья на заднем плане рисуются сквозь лежаки, два рядом стоящих лежака — один всегда поверх другого. **(2) Psycho Park** — зелёная зона слева от старта (ориентир: 2 статуи львов на входе): кусты перекрывают друг друга с артефактами, лавочка поверх куста, трава вокруг дерева поверх лавочки. Также в парке на той же миссии: огонь за лавочкой рисуется поверх неё. **The Fallen** — вывеска Hot Dawg (с картинкой собаки-хотдога) в начале миссии: зелёный текст иероглифами позади вывески просвечивает поверх неё. **Assassin** — провода рисуются поверх листвы деревьев (дерево рядом со стартовой позицией). Там же — спрайты света рисуются сквозь деревья, но **возможно это намеренный эффект** (glow сквозь листву), нужно сверить с оригиналом. **Rat Catch** — пар из трубы (сверху вниз, в начале миссии): полукруглые решётки и нижняя часть квадратной трубы на доме вдали рисуются поверх пара. Вероятно общая проблема sort order для vegetation/furniture/effects/вывесок/проводов. Нужно проверить как выглядит в релизной PC-версии. | Исследовать (сверить с оригиналом) |
...
| Персонажи слишком ярко освещены ночью | Auto Destruct — ночная миссия, окружение тёмное, но персонажи (особенно гражданские прохожие) выглядят слишком яркими, как будто на них отдельный источник света. Возможно баг с освещением персонажей или отсутствует ambient darkening для фигур. Нужно сверить с релизной PC-версией. | Исследовать (сверить с оригиналом) |
