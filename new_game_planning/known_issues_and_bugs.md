...
| Отладочная линия при броске гранаты видна в обычном режиме | При прицеливании гранатой рисуется debug trace line (линия траектории). Должна быть видна только в debug mode (Ctrl). Перенести отрисовку под проверку debug флага. | Исправить |
