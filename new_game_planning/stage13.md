...
- **Раздельные кнопки для действий** — сейчас многие действия на одной кнопке (action / multi-action). Разделить: действие (interact) на одну кнопку, бег на другую, ползание на третью и т.д. Для клавиатуры И геймпада. Полная переработка input mapping. (В 1.0 оригинальное multi-action поведение оставлено — играбельно.) → дублируется в [known_issues_and_bugs_post_1_0.md "Управление"](known_issues_and_bugs_post_1_0.md).
