...
Возможно будет отдельный лаунчер перед запуском игры, возможно всё будет внутри UI самой игры — нужно исследовать (на Steam Deck отдельный лаунчер неудобен).
