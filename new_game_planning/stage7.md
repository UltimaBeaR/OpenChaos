...
**C5 — Загрузочный экран просвечивает через первые кадры 🔍 В РАССЛЕДОВАНИИ:**
На 1-2 кадра сразу после загрузки уровня на небе и заднике (backdrop) виден
белёсый оверлей с очертаниями загрузочного экрана (луна + силуэт Дарси).
Проявляется ТОЛЬКО на первом запуске миссии после старта приложения.
При перезапуске миссии (выход в меню → повторный вход) — бага нет.
В старой версии (stage_5_1_done) НЕ воспроизводится.
Подробности расследования → [stage7_c5_investigation.md](../new_game_devlog/stage7_c5_investigation.md)
...
**Сводка багов:** C1 ✅, C2 ✅, C3 ✅, C4 ✅, C5 🔍 расследование, C6 ✅ не баг.
