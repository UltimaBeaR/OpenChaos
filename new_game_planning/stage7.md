...
- [ ] `ge_init_back_image` / `ge_show_back_image` / `ge_reset_back_image` — **задники меню** (приоритет!)
- [ ] `ge_create_background_surface` / `ge_blit_background_surface` / `ge_destroy_background_surface` — фоновая поверхность
