...
Известные проблемы:
- [ ] Ghost RGB: шрифты меню + HUD иконки → [`stage7_ghost_rgb_investigation.md`](../new_game_devlog/stage7_ghost_rgb_investigation.md)
- [ ] Тени с z-fighting (мерцание/полосы)
- [ ] Вода без alpha-прозрачности
- [ ] Листья не видны (возможно color key / alpha discard)
- [ ] Рамки окошка не видны
- [ ] Задник меню не отображается (screen surface стаб — Phase 6)
- [ ] Спросить у пользователя какие ещё визуальные баги есть (скриншоты)
TODO — собрать скриншоты, сравнить с D3D, пофиксить каждый баг
**Фаза 4 — 3D transforms:** ✅ (сделано в Фазе 2: MVP в lit vertex shader)
**Фаза 5 — Fog, alpha, effects:** ✅ (сделано в Фазе 2: всё в fragment shader)
**Фаза 6 — Framebuffer access:** TODO (wibble/puddles, screen capture, back image)
